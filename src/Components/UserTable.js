...
const UserTable = ({ users, deleteAllSelected, deleteSelected, addModaldata }) => {
    ...
    const toggleSelectedUser = (id, dependency = false) => {
                                ...
                                <tbody>
                                    {
                                        users.map((user) => {
                                            return (
                                                <tr key={user.id} onClick={() => toggleSelectedUser(user.id, false)}
