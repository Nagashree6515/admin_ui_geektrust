 ...
 * @param {function} paginationFun - Logic to set current page and the data in it
...
const Pagination = ({ currentPage, range, paginationFun, pageLimit, togglePage }) => {
